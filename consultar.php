	...
	<body>
		...
		<div class="content">
			...
			<div class="mainbar">
				...
				<div class="page-head">
					<!-- Encabezado -->
					<h2 class="pull-left">Ingrese el correlativo de denuncia
					  <!-- meta de la pagina -->
					  ...
					  <div class="row-fluid">
						<!-- Content -->
                                                ...
                                                <div class="col-md-7 col-lg-7 col-sm-7">
                                                    <div class="col-md-2 col-lg-2 col-sm-3">Correlativo:<br/></div>
                                                    <div class="col-md-10 col-lg-10 col-sm-9"><input type="text" placeholder="273912" name="nombre"></div>

                                                    <div class="form-group" style="padding-top: 50px;">
                                                        <button style="width: 300px;" type="button" id="btnConsultar" class="btn btn-success" href="exito.php">Consultar!</button>
                                                    </div>
                                                </div>
                 ...
                 <script language="javascript" type="text/javascript">
                    $(document).ready(function() {
                        $("#btnConsultar").click(function() {
                            window.location.href = "http://localhost/denunciasecys/mostrar_denuncia.php"; 
                            //return false;
                        });
                    });
                </script>
