	...
	<body>
		...
		<div class="content">
				...
				<div class="sidebar-inner">
					...
					<ul class="navi">
						...
						<li class="nred current"><a href="index.php"><i class="fa fa-desktop"></i> Inicio</a></li>
                                                <li class="nlightblue current"><a href="crear.php"><i class="fa fa-envelope-o"></i> Crear denuncia</a></li>
			...
			<div class="mainbar">
				...
				<div class="page-head">
					<!-- Encabezado -->
					<h2 class="pull-left">Creación de denuncia 
					  <!-- meta de la pagina -->
						...
						<!-- Content -->
                                               <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                ...
                                                <div class="col-md-7 col-lg-7 col-sm-7">
                                                    <form action="exito.php" method="post" class="form-horizontal" role="form">
                                                        <h4>Datos del denunciante</h4>
                                                            <div class="col-md-2 col-lg-2 col-sm-3">Nombre:</div>
                                                            <div class="col-md-10 col-lg-10 col-sm-9"><input type="text" placeholder="Nombres Apellidos" name="nombre"></div>
                                                            <div class="col-md-2 col-lg-2 col-sm-3">E-mail:</div>
                                                            <div class="col-md-10 col-lg-10 col-sm-9"><input type="text" placeholder="josecardona@email.com" name="email"></div>
                                                            <div class="col-md-2 col-lg-2 col-sm-3">Teléfono:</div>
                                                            <div class="col-md-10 col-lg-10 col-sm-9"><input type="text" placeholder="45454545" name="telefono"></div>
                                                        <hr/>
                                                        <h4>Datos la ubicación</h4>
                                                            <div class="col-md-2 col-lg-2 col-sm-3">Ubicación:</div>
                                                            <div class="col-md-10 col-lg-10 col-sm-9"><input type="text" placeholder="Ej. T3 salón 212" name="ubicacion"></div>
                                                        <hr/>
                                                        ...
                                                        <div class="form-group">
                                                            <button style="width: 300px;" type="button" id="btnCrear" class="btn btn-success" href="exito.php">Crear!</button>
                                                        </div>
                                                    </form>
                                                </div>
                ...
                <script language="javascript" type="text/javascript">
                    $(document).ready(function() {
                        $("#btnCrear").click(function() {
                            window.location.href = "http://localhost/denunciasecys/exito.php"; 
                            //return false;
                        });
                    });
                </script>
